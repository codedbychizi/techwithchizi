    ...
    <footer className="bg-brand-navy text-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
          <div className="flex items-center gap-2 mb-4">
            <svg width="32" height="32" viewBox="0 0 36 36" fill="none">
              ...
              <line x1="13" y1="18" x2="26" y2="10" stroke="white" strokeWidth="1.8" />
              <line x1="13" y1="18" x2="26" y2="26" stroke="#00c6ff" strokeWidth="1.8" />
            </svg>
            <span className="font-display font-bold text-lg">TechWithChizi</span>
          </div>
          <p className="text-gray-300 text-sm leading-relaxed max-w-xs">
            <strong className="text-white">TechWithChizi (TWC)</strong> is a web development
            agency focused on building professional, reliable, and easy-to-manage websites
            that support business growth, credibility, and long-term success.
          </p>
          {/* Social icons */}
          <div className="flex items-center gap-4 mt-5 text-gray-400">
            <a href="https://x.com/techwithchizi" target="_blank" rel="noreferrer"
               className="hover:text-white transition-colors" aria-label="X / Twitter">
            ...
            <a href="https://instagram.com/techwithchizi" target="_blank" rel="noreferrer"
            ...
            <a href="https://wa.me/2347073276471" target="_blank" rel="noreferrer"
               className="hover:text-white transition-colors" aria-label="WhatsApp">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div>
          ...
          <a href="mailto:techwithchizi@gmail.com"
      ...
      <div className="border-t border-white/10 py-4 text-center text-gray-400 text-sm">
        Copyright &copy; {new Date().getFullYear()} techwithchizi | All Rights Reserved.
      </div>
    </footer>
  )
}
